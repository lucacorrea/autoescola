...
<html lang="pt-br">
    <head>
        ...
        <!-- custom CSS -->
        <link rel="stylesheet" href="./painel/css/logout.css">
        <!-- End custom CSS -->
    ...
    <body>
        ...
        <div class="loader-container">
            ...
            <?php if (!empty($logoImage)): ?>
                <img src="./painel/uploads/<?php echo htmlspecialchars($associacao['logo_image'] ?? 'default.png'); ?>" class="loader-img logo-img mb-5" alt="Logo">
            <?php else: ?>
