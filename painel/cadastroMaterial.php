    ...
    <div class="container">
        ...
        <div class="col-12 mt-0" id="cadastro-material">
            <p class="title-categoria mb-0">
                <b>Cadastro de Material de Estudo</b>
            </p>
                        ...
                        <div class="card card-address card-title mt-3">
                            ...
                            <div class="card card-address cursor-default mt-2" style="border: 1px solid #000 !important;">
                                ...
                                <div class="infos config">
                                    ...
                                    <input type="file" name="capa" id="capaInput" accept="image/*" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-right mt-3">
                                <button type="submit" class="btn btn-white btn-sm active" style="padding: 6px 13px !important;">Cadastrar Material</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-preview">
                        <div class="card-body text-center">
                            ...
                            <img id="previewCapa" src="#" alt="Prévia da Capa" style="display: none;">
                        </div>
                    </div>
                </div>
            </div>
